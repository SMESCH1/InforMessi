# Ejemplos de Mensajes - InforMessi

Esta colección muestra ejemplos de mensajes bien formados para diferentes situaciones.

---

## Ejemplo 1: Con Evento Importante (Cumpleaños)
...
## Ejemplo 2: Con Partido Relevante
...
La Scaloneta llega con la base campeona intacta. Messi, Di María y el resto del grupo histórico siguen siendo el corazón del equipo, pero hay espacio para sorpresas en la convocatoria final.

Dato del día: Argentina y Brasil se enfrentaron por última vez en un Mundial en la final de 2022, con victoria albiceleste.
...
**¿Qué hace bien este ejemplo?**
- Prioriza el evento del día (partido)
- Contextualiza la importancia del partido
- Mantiene el foco en Argentina sin desmerecer al rival
- Usa datos reales y verificables
- Tono informativo, no sensacionalista

---

## Ejemplo 3: Día Sin Evento Especial (Formato Estándar)
...
Dato del día: El Mundial 2026 se jugará en 16 ciudades de Estados Unidos, Canadá y México, siendo el más distribuido geográficamente de la historia.
...
**¿Qué hace bien este ejemplo?**
- Funciona sin evento destacado del día
- Usa noticia reciente (horarios confirmados)
- Mantiene interés con información relevante
- Estructura completa y balanceada
- No fuerza contenido innecesario

---

## Ejemplo 4: Con Anuncio Oficial
...
Dato del día: Argentina defenderá el título en un formato expandido a 48 equipos, algo que nunca había ocurrido en la historia de los Mundiales.
...
**¿Qué hace bien este ejemplo?**
- Prioriza el anuncio oficial del día
- Balancea novedad con continuidad (base campeona)
- Mantiene expectativa sin exagerar
- Información precisa y verificable

---

## Ejemplo 5: Día con Fecha Patria Argentina
...
Dato del día: Argentina es el único país sudamericano que ha ganado el Mundial en tres continentes diferentes: América (1978, 1986), Europa (2022) y ahora buscará en Norteamérica.
...
**¿Qué hace bien este ejemplo?**
- Integra la fecha patria de forma natural
- Conecta el contexto histórico con el fútbol
- No fuerza la conexión, fluye naturalmente
- Mantiene el foco en el Mundial y la selección
...
5. **Priorización clara**: Si hay evento importante, es el centro
6. **Cierre ritual**: Siempre incluyen "Coronados de gloria vivamos"
7. **Formato limpio**: Texto plano, sin markdown, listo para publicar
